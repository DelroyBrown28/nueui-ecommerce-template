...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('size_label', models.CharField(blank=True, default='', help_text='xs, s, m, l, xl', max_length=15, null=True)),
                ('size_price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('size_label_2', models.CharField(blank=True, default='', help_text='xs, s, m, l, xl', max_length=15, null=True)),
                ('size_price_2', models.DecimalField(decimal_places=2, default='2', max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('price', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.sizeprice')),
            ],
        ),
    ]
