    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_product_image', models.ImageField(blank=True, null=True, upload_to='product_images')),
                ('alternative_image_1', models.ImageField(blank=True, null=True, upload_to='product_images')),
                ('alternative_image_2', models.ImageField(blank=True, null=True, upload_to='product_images')),
