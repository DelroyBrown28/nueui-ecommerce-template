# Generated by Django 3.2.3 on 2021-08-17 20:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('page_customisations', '0014_headercustomisation_button_border_color'),
    ]

    operations = [
        migrations.AddField(
            model_name='headercustomisation',
            name='mobile_banner_button_background_color',
            field=colorfield.fields.ColorField(default='#FFFFFF', max_length=18),
        ),
        migrations.AddField(
            model_name='headercustomisation',
            name='mobile_banner_button_label_color',
            field=colorfield.fields.ColorField(default='#000000', max_length=18),
        ),
        migrations.AddField(
            model_name='headercustomisation',
            name='mobile_button_border',
            field=models.TextField(blank=True, choices=[('add-border', 'Add Border'), ('no-border', 'Remove Border')], default='no-border', null=True),
        ),
        migrations.AddField(
            model_name='headercustomisation',
            name='mobile_button_border_color',
            field=colorfield.fields.ColorField(default='#000000', max_length=18),
        ),
