...
class GlobalSiteStyling(models.Model):
    ...
    dropdown_menu_background_color = ColorField(format='hex', default='#FFFFFF')
...
class HomePageCustomisation(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, upload_to='home_page_images')
...
class AboutPageCustomisation(models.Model):
    ...
    contact_card_title = models.CharField(max_length=100, blank=False, null=False, default='Business Name')
    ...
    twitter_link = models.URLField(max_length=200, default='https://twitter.com/')
    linkedin_link = models.URLField(max_length=200, default='https://linkedin.com/')
    facebook_link = models.URLField(max_length=200, default='https://facebook.com/')
    instagram_link = models.URLField(max_length=200, default='https://instagram.com/')
